...
},{"./TweenLite.js":"node_modules/gsap/TweenLite.js"}],"plugins/DrawSVGPlugin.js":[function(require,module,exports) {
"use strict";
 ...
 * @author: Jack Doyle, jack@greensock.com
 */
var _doc = _TweenLite._gsScope.document,
    _getComputedStyle = _doc.defaultView ? _doc.defaultView.getComputedStyle : function () {},
    _numbersExp = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/ig,
    _isEdge = ((_TweenLite._gsScope.navigator || {}).userAgent || "").indexOf("Edge") !== -1,
...
exports.default = exports.DrawSVGPlugin = DrawSVGPlugin;
...
function unwrap(element) {
  if (typeof element === "string" || !element.nodeType) {
    element = _TweenLite._gsScope.TweenLite.selector(element);
...
exports.default = exports.DrawSVGPlugin = DrawSVGPlugin = _TweenLite._gsScope._gsDefine.plugin({
  propName: "drawSVG",
  API: 2,
  version: "0.2.0",
  global: true,
...
},{"gsap/TweenLite.js":"node_modules/gsap/TweenLite.js"}],"script.js":[function(require,module,exports) {
"use strict";
...
_ScrollToPlugin.ScrollToPlugin;
...
var beard = document.querySelector('#beard');
var hat = document.querySelector('#hat');
var staff = document.querySelector('#staff');
var leftHand = document.querySelector('#left');
var content = document.querySelectorAll('.card-holder');
var title = document.querySelector('h1');
var merlinSvg = document.querySelectorAll('#Merlin path, #Merlin circle, #Merlin polygon');
...
setTl.set('#Merlin', {
  ...
  y: -500,
  autoAlpha: 0
}, 0).play().eventCallback('onComplete', function () {
  _gsap.TweenMax.to('.loader', .2, {
    autoAlpha: 0,
...
function animateWizard() {
  var animatable = document.querySelectorAll('[data-animate]');
  var whirlWindPaths = document.querySelectorAll('#whirlwind path');

  _gsap.TweenMax.globalTimeScale(.75);

  var summonTl = new TimelineMax({
    paused: true
  });
  var merlinFlyIn = new TimelineMax({
    delay: 1.5,
    paused: true
  });
  var merlinFlyOut = new TimelineMax({
    paused: true
  });
  var whirlWind = new TimelineMax({
    paused: true
  });
  ...
  var wwDur = .05;
  whirlWindPaths.forEach(function (wwPath) {
  ...
  merlinFlyIn.play().eventCallback('onComplete', function () {
    _gsap.TweenMax.to(hat, 0.2, {
      autoAlpha: 1
    });

    _gsap.TweenMax.to(hat, 0.75, {
      y: 15,
      ease: Power4.easeOut,
    ...
    summonTl.play().eventCallback('onComplete', function () {
      whirlWind.play();

      _gsap.TweenMax.delayedCall(wwDur * whirlWindPaths.length, function () {
        whirlWind.reverse().timeScale(3.5);
        merlinFlyOut.play().eventCallback('onComplete', function () {
...
var mouseOutTween; // set on mouse-out

function addHoverPerspectiveAnimation() {
  var cards = document.querySelectorAll('.card');

  _gsap.TweenMax.set(cards, {
  ...
  cards.forEach(function (card) {
    ...
    card.addEventListener('mouseout', function (e) {
      ...
      mouseOutTween = _gsap.TweenMax.to(card, 0.25, {
        delay: 0.25,
        rotationX: 0,
        rotationY: 0
      });
...
var scrollValue = 0;
var contentWidth = document.querySelector('.card-container').getBoundingClientRect().width - window.innerWidth;
...
function replaceVerticalScrollByHorizontal(event) {
  if (event.deltaY !== 0) {
    ...
    if (scrollValue <= 0 && event.deltaY < 0 || scrollValue >= contentWidth && event.deltaY > 0) {
      ...
      _gsap.TweenMax.to(content[0], 0.15, {
        scrollTo: {
          x: scrollValue,
          y: 0
        },
...
},{"gsap":"node_modules/gsap/index.js","gsap/ScrollToPlugin":"node_modules/gsap/ScrollToPlugin.js","./plugins/DrawSVGPlugin":"plugins/DrawSVGPlugin.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
